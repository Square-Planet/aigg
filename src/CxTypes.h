...
#include <cstddef> // for size_t and ptrdiff_t
    ...
    // ^- ask stdint.h to include fixed-size literal macros (e.g., UINT64_C).
        ...
        using boost::int8_t;
            ...
            // since C++11 (and earlier C99), the fixed-size integral types are part of the standard.
            // Just get those. Note that this is also supposed to bring in macros UINT32_C etc. to
            // declare that a given literal is a integer constant of the corresponding type.
            // Interestingly, https://en.cppreference.com/w/cpp/header/cstdint does *NOT* mention
            // C++11 as a prerequisite for that, but I am almost 100% sure that this stuff was not
            // in standard C++98 (otherwise I'd certainly not have bothered with this or boost/cstdint)
            #include <cstdint>
